// AtomCompilerWorking.java - Полностью рабочий компилятор
import java.util.*;
import java.nio.file.*;

public class AtomCompilerWorking {
    ...
    static class Parser {
        ...
        private ASTNode parsePrimary() {
            ...
            if (t.type == TOKEN_IDENT) {
                ...
                pos++;
                // Регистрируем переменную, если её ещё нет
                getVarName(name);
        ...
        private ASTNode parseAssignment() {
            ...
            if (t.type == TOKEN_IDENT) {
                ...
                if (pos < tokens.size() && tokens.get(pos).type == TOKEN_ASSIGN) {
                    ...
                    // Регистрируем переменную в левой части
                    getVarName(name);
    ...
    static class CodeGenerator {
        ...
        String generate(ASTNode ast) {
            ...
            for (Map.Entry<String, String> entry : varMap.entrySet()) {
                ...
                System.out.println("  $" + entry.getValue() + " (переменная " + entry.getKey() + ")");
            }
            wat.append("\n");
            ...
            if (!ast.statements.isEmpty()) {
                ...
                wat.append("    ;; Возвращаем ").append(last.identName).append("\n");
    ...
    public static void main(String[] args) throws Exception {
        if (args.length < 1) {
            System.err.println("Usage: java AtomCompilerWorking <file.atom>");
            System.exit(1);
        }
        ...
        try {
            ...
            if (exitCode == 0) {
                ...
                System.out.println("⚠️  Ошибка конвертации");
            }
        } catch (Exception e) {
            System.out.println("⚠️  wat2wasm не найден, пропускаем");
        }
    }
}
