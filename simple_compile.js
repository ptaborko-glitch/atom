...
console.log('Токены:', token1, token2, token3, token4);
console.log('Значения:', val1, val2, val3);

if (token1 === 0 && token2 === 2 && token3 === 0) {
  ...
  (export "main" (func $main))
    ...
    fs.writeFileSync('simple.wat', wat);
    console.log('simple.wat создан');
}
