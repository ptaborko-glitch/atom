...
console.log('\n✅ working.wat создан');
console.log('\n🔧 Скомпилируйте: wat2wasm working.wat -o working.wasm');
console.log('🔧 Запустите: node -e "require(\"fs\").readFileSync(\"working.wasm\").then(m => WebAssembly.instantiate(m)).then(i => console.log(i.instance.exports.main()))"');
