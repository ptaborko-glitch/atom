...
function parseProgram() {
    ...
    while (iteration < maxIterations) {
        ...
        // Если достигли EOF или нет больше токенов, выходим
        if (currentToken === exports.TOKEN_EOF.value || currentToken === undefined) {
            break;
        }
        
        // Если токен не IDENT, выходим (конец)
        if (!peek(exports.TOKEN_IDENT.value)) {
            console.log(`Неожиданный токен: ${currentToken}, завершаем`);
            break;
        }
