...
const t4 = exports.lexer_next_token();
const v4 = exports.lexer_token_value.value;
console.log(`Токен 4: ${t4}, значение: ${v4}`);

const t5 = exports.lexer_next_token();
const v5 = exports.lexer_token_value.value;
console.log(`Токен 5: ${t5}, значение: ${v5}`);

if (t1 === 1 && t2 === 7 && t3 === 0 && t4 === 2 && t5 === 0) {
    const varName = `var${v1}`;
    const left = v3;
    const right = v5;
