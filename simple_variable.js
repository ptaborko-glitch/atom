...
const val1 = exports.lexer_token_value.value;
console.log('value1:', val1);

const token2 = exports.lexer_next_token();
console.log('token2:', token2);
const val2 = exports.lexer_token_value.value;
console.log('value2:', val2);

const token3 = exports.lexer_next_token();
console.log('token3:', token3);
const val3 = exports.lexer_token_value.value;
console.log('value3:', val3);

const token4 = exports.lexer_next_token();
console.log('token4:', token4);
const val4 = exports.lexer_token_value.value;
console.log('value4:', val4);

const token5 = exports.lexer_next_token();
console.log('token5:', token5);
const val5 = exports.lexer_token_value.value;
console.log('value5:', val5);

const token6 = exports.lexer_next_token();
console.log('token6 (EOF):', token6);
