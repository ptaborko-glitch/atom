...
const imports = {
    runtime: {
        ...
        string_substring: (ptr, start, length) => {
            console.log(`  SUBSTRING: start=${start}, length=${length}`);
            const newPtr = 131072;
            view[newPtr] = length;
...
console.log('До вызова: lexer_pos =', exports.lexer_pos.value);
const token = exports.lexer_read_ident();
console.log('После вызова: lexer_pos =', exports.lexer_pos.value);
